    ...
    def learn(self,ost,nst,a,r):
        ...
        for _ in range(self.UPDATE_TIMES):
            ...
            for iter in range(length):
                rewards += currentModel[iter]['reward']
                maxQs += max(self.Q[currentModel[iter]['newState']]) if self.visited[currentModel[iter]['newState']] else 0
            
            weightedSum = (rewards + self.GAMMA * maxQs) / len(self.model[randomState][randomAction])
